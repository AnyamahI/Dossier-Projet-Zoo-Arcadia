...
ini_set('display_errors', 1); // Inclure le fichier contact.php include('back/php/contact.php'); 
?>
...
<body>
    ...
    <header>
        <nav>
            <div class="logo">
                <a href="/html/index.html"><img src="/média/média/Logo_ArcadiaV2.png" alt=""></a>
            </div>
    ...
    <section class="sec4">
        ...
        <div class="container-animaux">
            ...
            <div class="container-zebre_goril_loutre">
                ...
                <img class="loutre" src="/média/média/loutre-unsplash.jpg" alt="">
            </div>
        </div>
        </div>
